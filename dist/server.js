...
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar models_1 = __webpack_require__(/*! ../models */ \"./src/server/db/models/index.ts\");\nvar filterByCategory = function (id) {\n    return models_1.default(\"SELECT p.ProductID, p.Name, p.Price, p.StockLevel, p.OnSale, c.CategoryID, c.Name as CategoryName from products as p INNER JOIN categories as c ON p.CategoryID = c.CategoryID WHERE p.CategoryID = ?\", [id]);\n};\nexports.default = filterByCategory;\n\n\n//# sourceURL=webpack://template2/./src/server/db/queries/filtered_products.ts?");
